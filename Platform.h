...
#define BC_CACHE_LINE_SIZE 64
	...
	defined(__powerpc64__) || defined(__ppc64__) || defined(__LP64__)
#undef BC_ARCH_64BIT
...
#if !BC_CRT_BIONIC && !BC_CRT_BSD && !BC_CRT_GLIBC && !BC_CRT_LIBCXX && !BC_CRT_MINGW && !BC_CRT_MSVC && !BC_CRT_NEWLIB
#undef BC_CRT_NONE
...
///
#define BC_PLATFORM_POSIX                                                                                              \
	(0 || BC_PLATFORM_ANDROID || BC_PLATFORM_BSD || BC_PLATFORM_EMSCRIPTEN || BC_PLATFORM_HAIKU || BC_PLATFORM_HURD || \
	 BC_PLATFORM_IOS || BC_PLATFORM_LINUX || BC_PLATFORM_NX || BC_PLATFORM_OSX || BC_PLATFORM_PS4 ||                   \
	 BC_PLATFORM_PS5 || BC_PLATFORM_RPI)

///
#define BC_PLATFORM_NONE                                                                                               \
	!(0 || BC_PLATFORM_ANDROID || BC_PLATFORM_BSD || BC_PLATFORM_EMSCRIPTEN || BC_PLATFORM_HAIKU ||                    \
	  BC_PLATFORM_HURD || BC_PLATFORM_IOS || BC_PLATFORM_LINUX || BC_PLATFORM_NX || BC_PLATFORM_OSX ||                 \
	  BC_PLATFORM_PS4 || BC_PLATFORM_PS5 || BC_PLATFORM_RPI || BC_PLATFORM_WINDOWS || BC_PLATFORM_WINRT ||             \
	  BC_PLATFORM_XBOXONE)

///
#define BC_PLATFORM_OS_CONSOLE                                                                                         \
	(0 || BC_PLATFORM_NX || BC_PLATFORM_PS4 || BC_PLATFORM_PS5 || BC_PLATFORM_WINRT || BC_PLATFORM_XBOXONE)

///
#define BC_PLATFORM_OS_DESKTOP                                                                                         \
	(0 || BC_PLATFORM_BSD || BC_PLATFORM_HAIKU || BC_PLATFORM_HURD || BC_PLATFORM_LINUX || BC_PLATFORM_OSX ||          \
	 BC_PLATFORM_WINDOWS)

///
#define BC_PLATFORM_OS_EMBEDDED (0 || BC_PLATFORM_RPI)

///
#define BC_PLATFORM_OS_MOBILE (0 || BC_PLATFORM_ANDROID || BC_PLATFORM_IOS)

///
#define BC_PLATFORM_OS_WEB (0 || BC_PLATFORM_EMSCRIPTEN)

///
#if BC_COMPILER_GCC
#define BC_COMPILER_NAME                                                                                               \
	"GCC " BC_STRINGIZE(__GNUC__) "." BC_STRINGIZE(__GNUC_MINOR__) "." BC_STRINGIZE(__GNUC_PATCHLEVEL__)
#elif BC_COMPILER_CLANG
#define BC_COMPILER_NAME                                                                                               \
	"Clang " BC_STRINGIZE(__clang_major__) "." BC_STRINGIZE(__clang_minor__) "." BC_STRINGIZE(__clang_patchlevel__)
...
#define BC_PLATFORM_NAME "Android " BC_STRINGIZE(BC_PLATFORM_ANDROID)
#elif BC_PLATFORM_BSD
#define BC_PLATFORM_NAME "BSD"
#elif BC_PLATFORM_EMSCRIPTEN
#define BC_PLATFORM_NAME                                                                                               \
	"asm.js " BC_STRINGIZE(__EMSCRIPTEN_major__) "." BC_STRINGIZE(__EMSCRIPTEN_minor__) "." BC_STRINGIZE(              \
		__EMSCRIPTEN_tiny__)
